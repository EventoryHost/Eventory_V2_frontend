...
const HERO_SLIDES = [
    ...
    content: (
      <h1 className="text-white text-4xl font-semibold leading-tight drop-shadow-md">
        <span className="block mb-1">
          Turn your <span className="italic font-normal">services</span>
        </span>
        <span>
  ...
  },
  {
    ...
    content: (
      <h1 className="text-white text-4xl font-semibold leading-tight drop-shadow-md">
        <span className="block mb-1">
          Reach <span className="italic font-normal">customers</span> who
        </span>
        <span>
      ...
      if (data.success) {
        if (typeof window !== "undefined") {
          if (data.vendor?.businessName)
            localStorage.setItem("vendor_name", data.vendor.businessName);
          ...
          if (data.vendor?.isDarkMode !== undefined) {
            localStorage.setItem(
              "theme",
              data.vendor.isDarkMode ? "dark" : "light",
            );
          }
        }
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] flex items-center justify-center p-0 sm:p-4 font-figtree">
      <div className="w-full max-w-md h-screen sm:h-[850px] bg-white sm:rounded-[40px] shadow-2xl overflow-hidden relative flex flex-col">
        {/* Hero Section */}
        <div
          className={`relative w-full transition-all duration-500 overflow-hidden ${step === 0 ? "h-[72%]" : "h-[35%]"}`}
        >
        ...
        <div className="flex-1 bg-white rounded-t-[32px] -mt-8 relative z-20 px-8 pt-6 pb-8 flex flex-col shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
          <AnimatePresence mode="wait">
                    ...
                    <div className="flex items-center gap-3 w-full">
                      ...
                      <div className="relative group flex items-center">
                        ...
                        <div className="absolute bottom-full right-0 mb-3 w-[220px] p-3 bg-[#030303] text-white text-[13px] leading-snug rounded-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible focus-within:opacity-100 focus-within:visible transition-all z-50 shadow-xl pointer-events-none">
                          You are already logged in with ID:{" "}
            ...
            {step === 1 && (
              ...
              >
                <div className="space-y-2">
                  <h2 className="text-2xl font-bold text-[#030303]">
                    Welcome Back
                  </h2>
                ...
                <div className="space-y-4 flex-1">
                  <div
                    className={`flex items-center w-full border rounded-xl px-4 transition-all bg-[#F9FAFB] ${status.error ? "border-red-500" : "border-gray-200 focus-within:border-[#04222D] focus-within:ring-1 focus-within:ring-[#04222D]"}`}
                  >
                    <span className="text-gray-500 font-medium py-4 pr-3 border-r border-gray-200">
                      +91
                    </span>
                    <input
                      autoFocus
            ...
            {step === 2 && (
              ...
              >
                <div>
                  <h2 className="text-[17px] font-bold text-[#262634] leading-tight font-figtree">
                  ...
                  <div className="flex justify-between items-start min-h-[24px] font-figtree">
                    <div className="flex-1">
                      ...
                      {!status.error && !status.success && timer > 0 && (
                        <p className="text-[#A8A9B3] text-[10px] leading-[14px]">
                          Resend in {timer}s
                        </p>
                      )}
                    </div>
