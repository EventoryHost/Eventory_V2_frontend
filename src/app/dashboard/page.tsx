            ...
            <AnimatePresence>
                {dashboardStep < 3 && (
                    <motion.div 
                        ...
                        className="bg-[#04222D] text-white px-6 py-4 flex justify-between items-center cursor-pointer overflow-hidden" 
                        onClick={() => router.push('/dashboard/setup-profile')}
                    >
                        <span className="text-[14px] font-bold">Complete your profile</span>
