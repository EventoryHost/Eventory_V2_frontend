...
export default function ReadyToPlanBanner() {
  return (
    <section
      className="relative mx-auto mt-16 h-[336px] w-full max-w-[1312px] overflow-hidden rounded-[48px] bg-[#FCDFE2]"
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex h-full max-w-[692px] flex-col items-start justify-center gap-4 pl-8 lg:pl-12">
        <h2 className="font-figtree font-bold text-brand-950 text-[28px] sm:text-[32px] leading-[1.2] tracking-[-0.02em]">
          Ready to plan your perfect Event?
        </h2>
        <p className="w-[692px] max-w-full font-figtree font-normal text-[16px] leading-[22px] tracking-[-0.01em] text-body-secondary">
