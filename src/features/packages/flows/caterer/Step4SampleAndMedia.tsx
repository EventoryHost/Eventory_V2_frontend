        ...
        <div className="flex flex-col gap-6 mt-6 pb-32">
            <div>
                ...
                <div className="bg-[#F4F4F5] p-4 rounded-[12px]">
                    <label className="w-full py-10 px-4 rounded-[12px] border border-dashed border-[#E4E4E7] bg-white flex flex-col items-center justify-center hover:bg-gray-50 transition-colors mb-4 cursor-pointer text-center block">
