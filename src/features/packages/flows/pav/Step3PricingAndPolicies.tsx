...
export default function PAVStep3PricingAndPolicies({
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex p-1 bg-[#F4F4F5] rounded-[12px] relative">
                            <button onClick={() => setPackageChargeType('Per Performance')} className={`flex-1 py-3 text-[14px] font-semibold rounded-[10px] relative z-10 transition-colors ${packageChargeType === 'Per Performance' ? 'text-[#030303]' : 'text-[#71717B]'}`}>Per Performance</button>
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="relative">
                            ...
                            <input type="text" placeholder="5,000" value={packagePrice} onChange={e => setPackagePrice(e.target.value)} className={`${INPUT} pl-11`} />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className={CARD}>
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                        <label style={{ fontFamily: 'Figtree, sans-serif' }} className={LABEL}>How do you charge?</label>
                        <div className="flex p-1 bg-[#F4F4F5] rounded-[12px] relative">
                            <button onClick={() => setTeamChargeType('Per Performance')} className={`flex-1 py-3 text-[14px] font-semibold rounded-[10px] relative z-10 transition-colors ${teamChargeType === 'Per Performance' ? 'text-[#030303]' : 'text-[#71717B]'}`}>Per Performance</button>
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="relative">
                            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#030303] text-[15px] font-normal" style={{ fontFamily: 'Figtree, sans-serif' }}>Rs.</span>
                            <input type="text" placeholder="3,000" value={teamPrice} onChange={e => setTeamPrice(e.target.value)} className={`${INPUT} pl-11`} />
                        </div>
                    </div>
                </div>
            </div>
