...
interface Props {
    ...
    photographersCount: string; setPhotographersCount: (v: string) => void;
    videographersCount: string; setVideographersCount: (v: string) => void;
    otherRoles: string; setOtherRoles: (v: string) => void;
...
export default function PAVStep1EventAndTeam({
    ...
    photographersCount, setPhotographersCount,
    videographersCount, setVideographersCount,
    otherRoles, setOtherRoles,
    ...
    return (
        <div className="flex flex-col gap-6 pb-32 w-full min-w-0">
            ...
            <div className={CARD}>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1">
                        <label style={{ fontFamily: 'Figtree, sans-serif' }} className={SMALL_LABEL}>Photographers</label>
                        <input
                            type="text"
                            placeholder="Number"
                            value={photographersCount}
                            onChange={(e) => setPhotographersCount(e.target.value.replace(/\D/g, ''))}
                            style={{ fontFamily: 'Figtree, sans-serif' }}
                            className={INPUT}
                        />
                    </div>
                    <div className="flex flex-col gap-1">
                        <label style={{ fontFamily: 'Figtree, sans-serif' }} className={SMALL_LABEL}>Videographers</label>
                        <input
                            type="text"
                            placeholder="Number"
                            value={videographersCount}
                            onChange={(e) => setVideographersCount(e.target.value.replace(/\D/g, ''))}
                            style={{ fontFamily: 'Figtree, sans-serif' }}
                            className={INPUT}
                        />
                    </div>
                ...
                <div className="flex flex-col gap-1">
                    <label style={{ fontFamily: 'Figtree, sans-serif' }} className={SMALL_LABEL}>Other Roles</label>
                    <textarea
                        placeholder="Mixed Input field"
                        value={otherRoles}
                    ...
                    />
                    <p style={{ fontFamily: 'Figtree, sans-serif' }} className="text-[12px] font-normal text-[#9F9FA9] leading-[18px] mt-1 ml-1">Specify role and numbers eg - "1 BTS Videographer"</p>
                </div>
            </div>
